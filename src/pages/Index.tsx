...
import { Search, File, Tag, Calendar, User, Download, FileText, Grid3X3, List, Folder, Settings, LogOut, ChevronDown, MessageSquare, Filter, X, Plus, Eye } from 'lucide-react';
                  ...
                  {filteredDocuments.map((doc) => (
                    <Card key={doc.id} className="hover:shadow-md transition-all duration-200 cursor-pointer group">
                      <CardContent className="p-3">
                        <div 
                          className="aspect-[3/4] bg-gray-100 rounded-lg mb-3 flex items-center justify-center cursor-pointer"
